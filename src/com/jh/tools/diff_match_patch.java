...
public class diff_match_patch {
  ...
  /**
   * The data structure representing a diff is a Linked list of DiffTest objects:
   * {DiffTest(Operation.DELETE, "Hello"), DiffTest(Operation.INSERT, "Goodbye"),
   *  DiffTest(Operation.EQUAL, " world.")}
   ...
   * @return Linked List of DiffTest objects.
   */
   ...
   * @return LinkedList of DiffTest objects.
   */
  protected LinkedList<Diff> diff_bisect(String text1, String text2,
    ...
    // DiffTest took too long and hit the deadline or
   ...
   * text.
   * @param diffs LinkedList of DiffTest objects.
   * @param lineArray List of unique strings.
   */
  ...
  public void diff_cleanupEfficiency(LinkedList<Diff> diffs) {
    ...
    Diff thisDiff = pointer.next();
    Diff safeDiff = thisDiff;  // The last DiffTest that is known to be unsplitable.
    while (thisDiff != null) {
      if (thisDiff.operation == Operation.EQUAL) {
        // Equality found.
  ...
  /**
   * Convert a DiffTest list into a pretty HTML report.
   * @param diffs LinkedList of DiffTest objects.
   ...
   * @param diffs Array of DiffTest objects.
   * @return Delta text.
   */
   ...
   * @return Array of DiffTest objects or null if invalid.
   ...
   * @param diffs Array of DiffTest objects for text1 to text2.
   * @return LinkedList of Patch objects.
   */
   ...
   * @param diffs Array of DiffTest objects for text1 to text2.
   * @return LinkedList of Patch objects.
   * @deprecated Prefer patch_make(String text1, LinkedList<DiffTest> diffs).
   */
  public LinkedList<Patch> patch_make(String text1, String text2,
      LinkedList<Diff> diffs) {
    return patch_make(text1, diffs);
  ...
  public static class Diff {
    ...
    /**
     * Display a human-readable version of this DiffTest.
     * @return text version.
     */
    public String toString() {
      String prettyText = this.text.replace('\n', '\u00b6');
      return "DiffTest(" + this.operation + ",\"" + prettyText + "\")";
    }

    /**
     * Create a numeric hash value for a DiffTest.
    ...
    /**
     * Is this DiffTest equivalent to another DiffTest?
     * @param obj Another DiffTest to compare against.
